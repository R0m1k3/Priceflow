...
SITE_CONFIGS = {
    ...
    "stokomani.fr": {
        ...
        "product_selector": ".product-miniature a, .js-product-miniature a, a.product-thumbnail",
    ...
    "bmstores.fr": {
        ...
        "product_selector": "a.product-thumbnail[href*='/produits/']:not([href*='/c/'])",
        "wait_selector": ".products, .product-miniature",
        "category": "Discount",
        "requires_proxy": False,
    },
    ...
    "lincroyable.fr": {
        ...
        "product_selector": ".product-miniature a, .js-product-miniature a",
        "wait_selector": ".products, .product-miniature",
        "category": "Discount",
        "requires_proxy": False,
    },
    "action.com": {
        ...
        "product_selector": "a.product-card__link, .product-card a",
