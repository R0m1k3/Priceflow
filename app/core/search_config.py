...
SITE_CONFIGS = {
    ...
    "e-leclerc.com": {
        ...
        "product_selector": "a[data-testid='product-link'], a[href*='/cat/'][href*='/sku/']",
        "product_image_selector": "img[data-testid='product-image'], img[src*='scene7'], img[loading='eager']",
        "wait_selector": "[data-testid='product-card'], [data-testid='product-link']",
    ...
    "carrefour.fr": {
        ...
        "product_selector": "a[data-testid='product-card-link'], a.product-card__link",
        "product_image_selector": "img[data-testid='product-card-image'], img[fetchpriority], img.ds-product-image__img",
        "wait_selector": "[data-testid='product-card'], article[data-testid]",
        "category": "Grande Surface",
        "requires_proxy": False,
    },
}
