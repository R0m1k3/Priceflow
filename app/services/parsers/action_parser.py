        ...
        for link in links:
            try:
                ...
                if title_el:
                    ...
                    # Fallback to specific spans or remove price info from text
                    # Often Action cards have a .title span
                    title = link.get_text(" ", strip=True)
                    # Remove price-like patterns from title if we had to get whole link text
